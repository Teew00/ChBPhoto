...
class AdminController extends AbstractController
{
    ...
    #[Route('/tarifs', name: 'app_admin_tarifs')]
    ...
    #[Route('/tarifs/new', name: 'app_admin_tarifs_new')]
    ...
    #[Route('/tarifs/{id}', name: 'app_admin_tarifs_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/tarifs/{id}', name: 'app_admin_tarifs_delete', methods: ['POST'])]
