(() => {
    ...
    sliders.forEach(function (slider) {
        let sliderRange = slider.querySelector('.slider-range');
        let sliderBefore = slider.querySelector('.slider-before');
        let sliderSeparator = slider.querySelector('.slider-separator');
